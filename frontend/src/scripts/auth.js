...
function recordLoginDay() {
  ...
  if (!activeDays.includes(dateKey)) activeDays.push(dateKey);
  localStorage.setItem("finlite_active_days", JSON.stringify(activeDays));
}
  ...
  loginForm.addEventListener("submit", async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        localStorage.removeItem("finlite_signup_profile");
...
if (signupForm) {
  signupForm.addEventListener("submit", async (e) => {
    ...
    localStorage.setItem(
      "finlite_signup_profile",
      JSON.stringify({ full_name: fullName, email, phone }),
    );
